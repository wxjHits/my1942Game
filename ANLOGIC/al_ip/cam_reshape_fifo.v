 ...
 ** File	:	C:/Users/hp/Desktop/my1942Game/ANLOGIC/al_ip/cam_reshape_fifo.v
 ** Date	:	2023 06 26
...
module cam_reshape_fifo #(parameter DATA_WIDTH_W = 1, 
    ...
    fifo_cross_domain_addr_process_al_cam_reshape_fifo #(.ADDR_WIDTH(ADDR_WIDTH_W)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_cam_reshape_fifo #(.ADDR_WIDTH(ADDR_WIDTH_R)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(shift_wraddr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_cam_reshape_fifo #(.DATAWIDTH_A(DATA_WIDTH_W),
...
// ===========================================================================
module fifo_cross_domain_addr_process_al_cam_reshape_fifo #(parameter ADDR_WIDTH = 9) (
...
// ===========================================================================
module ram_infer_cam_reshape_fifo (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
