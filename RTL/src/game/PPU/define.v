...
// `define VGA //显示方式的定义，注释掉该行，为HDMI显示
...
`define GAME_WINDOW_WIDTH_BIG 512 //游戏画面宽度
`define GAME_WINDOW_HEIGHT_BIG 480 //游戏画面高度
...
`define NAMETABLE_AHBBUS_ADDRWIDTH 9 //（32*30/4）
